...
kubectl delete -f ../manifests/sockshop-app/production/
...
kubectl delete -f ../manifests/backend-services/shipping-rabbitmq/production/
kubectl delete -f ../manifests/backend-services/user-db/production/
